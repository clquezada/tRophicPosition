...
If you are working in Windows, `devtools` also requires [Rtools](http://cran.r-project.org/bin/windows/Rtools/), or if you are working on a Mac, [Xcode](https://developer.apple.com/xcode/) (from Apple Store). In Linux you will need to install a compiler and various development libraries. 
...
Now we have to model each community within the Bayesian framework of `tRophicPosition` (as introduced previously in other vignettes, e.g. [a guide to the use of tRophicPosition](https://github.com/clquezada/tRophicPosition/raw/master/A_guide_to_the_use_of_tRophicPosition_2016-06-12.pdf)).
